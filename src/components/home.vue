...
<div>
     <!--========== SCROLL TOP ==========-->
        ...
        <header class="l-header" id="header">
            <nav class="nav bd-container">
                <a href="#" class="nav__logo">  <img src="../assets/michara.png" class="logo" alt="logo-michara" style="width:100px;height:auto;" /></a>
  ...
  <label class="toggle">
   ...
   <section class="home" id="home" v-scroll-reveal.reset="{ delay: 250 }">
  ...
  <h1 class="typing"></h1>
                    ...
                    <img src="../assets/food6.png" alt="" class="home__img">
            ...
            >
              ...
              <!--========== ABOUT ==========-->
            <section class="about section bd-container" id="about" v-scroll-reveal.reset="{ delay: 250 }">
                <div class="about__container  bd-grid">
                    ...
                    <img src="../assets/food8.png" alt="" class="about__img">
                </div>
            </section>
              <!--========== SERVICES ==========-->
            <section class="services section bd-container" id="services" v-scroll-reveal.reset="{ delay: 250 }">
               ...
               <!--===== APP =======-->
            <!-- <section class="app section bd-container" v-scroll-reveal.reset="{ delay: 250 }">
                ...
                <!--========== CONTACT US ==========-->
            <section class="contact section bd-container" id="contact" v-scroll-reveal.reset="{ delay: 250 }">
            ...
            <!-- footer-->
               <footer class="footer section bd-container" v-scroll-reveal.reset="{ delay: 250 }">
            <div class="footer__container bd-grid">
                <div class="footer__content">
                    <a href="#" class="footer__logo">Mi<span class="chara">Chara</span></a>
            ...
            <p class="footer__copy">&#169; 2021 MiChara. All right reserved</p>
        </footer>
...
.footer__description{
  ...
  margin: .25rem 0 var(--mb-3)!important;
}
...
.animated-text:before {
  content: "Try the best food of <br> the week.";
  animation: topToBottom 5s infinite 0s;
}

@keyframes topToBottom {
  0% {
    content: "Try the best food of the week.";
    animation-delay: 2s;
  ...
  75% {
    content: "we dey try for the best foods";
    animation-delay: 2s;
  }
  100% {
    content: "we dey try for the best foods";
